...
_PROCESS_PATH = Path(__file__).with_name("PROCESS_noaa_long_coastal Eastern coast.py")
_spec = importlib.util.spec_from_file_location("process_eastern_coast", _PROCESS_PATH)
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Download NOAA AIS day-by-day for the US East Coast, clean by region, "
            "and build long-horizon trajectory windows under data/processed/Eastern coast."
        )
    )
