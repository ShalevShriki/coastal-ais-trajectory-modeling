...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=(
            "Download NOAA AIS day-by-day for the US West Coast, clean by region, "
            "and build long-horizon trajectory windows under data/processed/West Coast."
        )
    )
    ...
    parser.add_argument(
        "--dataset-tag",
        help="Suffix for separate dataset storage, e.g. '4d' -> west_coast_4d.",
    )
